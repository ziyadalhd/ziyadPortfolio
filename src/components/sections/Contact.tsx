      ...
      <div className="grid gap-10 lg:grid-cols-[1fr_auto] lg:items-start">
        ...
        <div className="flex flex-col gap-3 lg:pt-1">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="contact-tile gap-4 lg:justify-end"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="18"
            ...
            <span className="text-sm">{personalInfo.linkedinDisplay}</span>
          </a>
          <a
          ...
          >
            ...
            <span className="text-sm">{personalInfo.githubDisplay}</span>
          </a>
        </div>
      </div>
    </section>
